...
class AuthService {
    constructor() {
        ...
        this.tokenUtils = require('../config/redis').tokenUtils;
    ...
    async refreshToken(refreshToken) {
        try {
            ...
            // Check if refresh token exists in Redis (additional security check)
            ...
            // Update refresh token in Redis and database
